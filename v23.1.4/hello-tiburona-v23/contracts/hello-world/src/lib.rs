...
mod test {
    ...
    #[test] // Test - No inicializar dos veces
    ...
    let resultado = client.try_initialize(&admin); // Usar try_initialize que retorna Result
    
    assert_eq!(resultado, Err(Ok(Error::NoInicializado))); // Verificar que es un error
    }

    #[test] // Test - Hello con validaciones
    ...
    assert_eq!(resultado, Err(Ok(Error::NombreVacio))); // Verificar que es un error
    }

    #[test] //Test - Reset solo admin
    ...
    #[test] //Test - Usuario no admin no puede resetear
    ...
    assert_eq!(resultado, Err(Ok(Error::NoAutorizado))); // Verificar que es un error
    }
}